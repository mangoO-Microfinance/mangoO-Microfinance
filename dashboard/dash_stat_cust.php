...
$cust_male = round(($cust_male/$cust_act)*100,1);
$cust_female = round(($cust_female/$cust_act)*100,1);
$cust_other = round(($cust_other/$cust_act)*100,1);

$cust_length1 = round(($cust_length1/$cust_act)*100,0);
$cust_length2 = round(($cust_length2/$cust_act)*100,0);
$cust_length3 = round(($cust_length3/$cust_act)*100,0);
$cust_length4 = ceil(($cust_length4/$cust_act)*100);
