...
<html>
				...
				<table id ="tb_fields" style="border-spacing:0.1em 1.25em;">
					...
					<?PHP					
						...
						echo '<tr>
							...
							echo '<td><select name="cust_married_id" class="defaultfield" size="1" tabindex="4">';
						...
						echo '<tr>
							...
							if (($result_cust['cust_lastsub']+31536000) < $timestamp ) $visibility = 'block';
	...
	if (($result_cust['cust_lastsub']+31536000) < $timestamp && $result_cust['cust_active'] == 1) {
		echo '<script language=javascript>alert(\'This Customer needs to renew his / her Subscription!\')</script>';
	}
	?>
</html>